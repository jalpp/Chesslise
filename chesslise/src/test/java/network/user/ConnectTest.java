...
// String msg = connect.insertEntry("12345213123", "user1",
// PreferencePl.LICHESS, PreferenceTc.CLASSICAL, new
// FriendPrefBuilder(PreferenceFr.MAGNUS, PreferenceFr.KNIGHT,
// PreferenceFr.SICILIAN, PreferenceFr.AGGRESSIVE));
...
// String msg2 = connect.insertEntry("12123423123", "user2",
// PreferencePl.UNAUTH_LICHESS, PreferenceTc.BLITZ, new
// FriendPrefBuilder(PreferenceFr.MAGNUS, PreferenceFr.KNIGHT,
// PreferenceFr.SICILIAN, PreferenceFr.AGGRESSIVE));
...
// String msg2 = connect.insertEntry("111111111111", "user3",
// PreferencePl.UNAUTH_LICHESS, PreferenceTc.BLITZ, new
// FriendPrefBuilder(PreferenceFr.GUKESH, PreferenceFr.KING,
// PreferenceFr.QUEENS_GAMBIT, PreferenceFr.AGGRESSIVE));
// System.out.println(msg2);
...
// @Order(4)
// void insertuser4() {
// String msg2 = connect.insertEntry("11111111112", "user4",
// PreferencePl.UNAUTH_LICHESS, PreferenceTc.BLITZ, new
// FriendPrefBuilder(PreferenceFr.GUKESH, PreferenceFr.KING,
// PreferenceFr.QUEENS_GAMBIT, PreferenceFr.AGGRESSIVE));
// System.out.println(msg2);
...
// @Order(5)
// void insertuser5() {
// String msg2 = connect.insertEntry("11111111113", "user5",
// PreferencePl.UNAUTH_LICHESS, PreferenceTc.BLITZ, new
// FriendPrefBuilder(PreferenceFr.GUKESH, PreferenceFr.KING,
// PreferenceFr.QUEENS_GAMBIT, PreferenceFr.AGGRESSIVE));
// System.out.println(msg2);
...
// String msg2 = connect.insertEntry("1111111111001", "user8",
// PreferencePl.UNAUTH_LICHESS, PreferenceTc.BLITZ, new
// FriendPrefBuilder(PreferenceFr.GUKESH, PreferenceFr.KING,
// PreferenceFr.QUEENS_GAMBIT, PreferenceFr.TACTICAL));
// System.out.println(msg2);
...
// String msg2 = connect.insertEntry("11111111112", "user4",
// PreferencePl.UNAUTH_LICHESS, PreferenceTc.BLITZ, new
// FriendPrefBuilder(PreferenceFr.FABI, PreferenceFr.PAWN,
// PreferenceFr.QUEENS_GAMBIT, PreferenceFr.AGGRESSIVE));
// System.out.println(msg2);
...
// @Order(8)
// void insertUser7() {
// String msg2 = connect.insertEntry("1111112121", "user6",
// PreferencePl.LICHESS, PreferenceTc.CLASSICAL, new
// FriendPrefBuilder(PreferenceFr.MAGNUS, PreferenceFr.KNIGHT,
// PreferenceFr.SICILIAN, PreferenceFr.AGGRESSIVE));
...
// Assertions.assertEquals("Successfully made your account offline! You won't
// see any challenges or friend pairings, to go online please run /connect",
// msg3);
...
// System.out.println(request.viewRequests("11111111113",
// ViewTypeFriend.LIST_FRIEND));
// }
...
// create.createChallenge("12123423123", "user2", "blitz", "unauthlichess",
// "pending");

// Pairing pairing = new Pairing(networkChallenges, networkPlayers,
// PairingNetworkType.PAIR_NETWORK_CHALLENGE);
...
// Create create = new Create(networkChallenges, networkPlayers);
// create.createChallenge("11111111113", "user5", "blitz", "unauthlichess",
// "pending");
// Pairing pairing = new Pairing(networkChallenges, networkPlayers,
// PairingNetworkType.PAIR_NETWORK_FRIEND);

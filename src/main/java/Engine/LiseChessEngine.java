        ...
        try {
            ...
            if(board.getSideToMove().equals(Side.WHITE)){
                ...
                if(!board.isKingAttacked()) {
                    ...
                    for (Move m : board.pseudoLegalCaptures()) {
                        if (board.getPiece(m.getTo()) != null) {
                            if (board.getPiece(m.getTo()).getPieceType().equals(PieceType.QUEEN)) {
                                return m;
                            }
                        }
                    }
                ...
                if(board.getSideToMove().equals(Side.WHITE)){
                    ...
                    if(!board.isKingAttacked()) {
                        ...
                        for (Move m : board.pseudoLegalCaptures()) {
                            if (board.getPiece(m.getTo()) != null) {
                                if (board.getPiece(m.getTo()).getPieceType().equals(PieceType.KNIGHT)) {
                                    return m;
                                }
                            }
                        }
                ...
                if(board.getSideToMove().equals(Side.WHITE)){
                    ...
                    if(!board.isKingAttacked()) {
                        ...
                        for (Move m : board.pseudoLegalCaptures()) {
                            if (board.getPiece(m.getTo()) != null) {
                                if (board.getPiece(m.getTo()).getPieceType().equals(PieceType.BISHOP) ) {
                                    return m;
                                }
                            }
                        }
                ...
                if(board.getSideToMove().equals(Side.WHITE)){
                    ...
                    if(!board.isKingAttacked()) {
                        ...
                        for (Move m : board.pseudoLegalCaptures()) {
                            if (board.getPiece(m.getTo()) != null) {
                                if (board.getPiece(m.getTo()).getPieceType().equals(PieceType.PAWN) && !board.getPiece(m.getFrom()).getPieceType().equals(PieceType.QUEEN) && !m.getTo().getRank().equals(Rank.RANK_7) && !m.getTo().getRank().equals(Rank.RANK_6) && !m.getTo().getRank().equals(Rank.RANK_8)) {
                                    return m;
                                }
                            }
                        }
                ...
                try {
                    ...
                    return LocalfindBestMove(board, 11);


                }catch (Exception e){

                    return board.legalMoves().get(board.legalMoves().size() - 1);
                }

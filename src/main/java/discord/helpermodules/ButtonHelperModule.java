...
public class ButtonHelperModule extends SettingSchemaModule {
    ...
    public void sendPlayingEngineFlow() {
        ...
        switch (buttonEvent.getComponentId()) {
            case "bot-lose" -> {
                ...
                buttonEvent
                        .editMessageEmbeds(new EmbedBuilder().setDescription("You have resigned the game!")
                                .setColor(Color.red).build())
                        .setActionRow(Button.danger("bot-lose", "Resgin").asDisabled(),
                                Button.secondary("bot-draw", "Draw").asDisabled())
                        .queue();
                try {
                    gameHandler.updateFen(buttonEvent.getUser().getId(),
            ...
            case "bot-draw" -> {
                buttonEvent
                        .editMessageEmbeds(new EmbedBuilder().setDescription("Chesslise accepts the draw!")
    ...
    public void sendPlayCommandFlow() {
        ...
        switch (buttonEvent.getComponentId()) {
            case "load-again" -> buttonEvent.reply("""
                    ...
                    """).addActionRow(
                    Button.success("casmode", "\uD83D\uDC4C Casual"), Button.danger("ratedmode", "\uD83E\uDD3A Rated"),
                    Button.success("friend", "\uD83D\uDDE1️ Play Friend"))
                    .addActionRow(Button.link("https://lichess.org/login", "\uD83D\uDD12 Login/Register"),
                            Button.secondary("playhelp", "❓ Help"), Button.success("cssnhelp", "❓ CSSN Network Help"))
                    .queue();
            case "loadr" ->
                buttonEvent.editMessage(" ## Please Pick Your Time Control ⏱️")
                        .setActionRow(Button.danger("3+0r", "\uD83D\uDD25 3+0"),
                                Button.danger("5+0r", "\uD83D\uDD25 5+0"), Button.danger("10+0r", "\uD83D\uDC07 10+0"),
                                Button.success("load-again", "↩️ Home"))
                        .queue();
            case "loadc" ->
                buttonEvent.editMessage(" ## Please Pick Your Time Control ⏱️")
                        .setActionRow(Button.primary("3+0c", " \uD83D\uDD253+0"),
                                Button.primary("5+0c", "\uD83D\uDD25 5+0"),
                                Button.primary("10+0c", "\uD83D\uDC07 10+0"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "3+0r" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(3, 0, true, client))
                        .setActionRow(Button.primary("3+0r", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "5+0r" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(5, 0, true, client))
                        .setActionRow(Button.primary("5+0r", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "10+0r" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(10, 0, true, client))
                        .setActionRow(Button.primary("10+0r", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "3+0c" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(3, 0, false, client))
                        .setActionRow(Button.primary("3+0c", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "5+0c" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(5, 0, false, client))
                        .setActionRow(Button.primary("5+0c", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "10+0c" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(10, 0, false, client))
                        .setActionRow(Button.primary("10+0c", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "playhelp" -> {
    ...
    public void sendPlayCommandUI() {
        ...
        switch (buttonEvent.getComponentId()) {
            case "casmode" -> buttonEvent.editMessage("## Please Pick Your Time Control ⏱️").setActionRow(
                    ...
                    Button.success("loadc", "\uD83D\uDD04 Load More Time Controls")).queue();
            ...
            case "ratedmode" -> buttonEvent.editMessage("## Please Pick Your Time Control ⏱️").setActionRow(
                    ...
                    Button.success("loadr", "\uD83D\uDD04 Load More Time Controls")).queue();
    ...
    public void sendPuzzleDBTheme() {
        switch (buttonEvent.getComponentId()) {
            case "loadpuzzles" ->
                buttonEvent.editMessageEmbeds(new EmbedBuilder().setDescription("Pick more for themes!").build())
                        .setActionRow(Button.success("sacrifice", "sacrifice"), Button.success("long", "long"),
    ...
    private void sendPuzzleThemeCard(String theme) {
        ...
        buttonEvent.editMessageEmbeds(puzzle.defineCommandCard(setting).build())
                .setActionRow(Button.link(puzzle.defineAnalysisBoard(puzzle.definePuzzleFen()), "Analysis Board"))
                .setActionRow(Button.link(puzzle.getGameURL(), "Game")).queue();
    }
    ...
    private void sendChessDBMove(int moveNumber) {
        ...
        String move = ChessDBQuery.getTop3Moves(buttonEvent.getMessage().getEmbeds().get(0).getDescription())
                .get(moveNumber);
        ...
        buttonEvent.getHook().editOriginalEmbeds(chessDBView.build())
                .setActionRow(Button.success("onemove", "Play 1st move"), Button.success("twomove", "Play 2nd move"),
    ...
    public void sendFlipBoard() {
        if (buttonEvent.getComponentId().equalsIgnoreCase("flip-board")) {
            ...
            buttonEvent
                    .replyEmbeds(new EmbedBuilder().setColor(Color.BLUE).addField("Share", gameShareUrl, true)
                            .setImage(gameShareUrl).setThumbnail(Thumbnail.getChessliseLogo()).build())
    ...
    public void sendMoreTimeControls() {
        ...
        switch (buttonEvent.getComponentId()) {
            case "ultrafastc" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(0, 0, false, client))
                        .setActionRow(Button.primary("ultrafastc", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "bulletfastc" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(1, 0, false, client))
                        .setActionRow(Button.primary("bulletfastc", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "blitzfastc" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(3, 2, false, client))
                        .setActionRow(Button.primary("blitzfastc", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "rapidfastc" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(5, 5, false, client))
                        .setActionRow(Button.primary("rapidfastc", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
        }

        switch (buttonEvent.getComponentId()) {
            case "ultrafastr" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(0, 0, true, client))
                        .setActionRow(Button.primary("ultrafastr", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "bulletfastr" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(1, 0, true, client))
                        .setActionRow(Button.primary("bulletfastr", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "blitzfastr" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(3, 2, true, client))
                        .setActionRow(Button.primary("blitzfastr", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
            case "rapidfastr" ->
                buttonEvent.editMessage(Game.generateOpenEndedChallengeURLs(5, 5, true, client))
                        .setActionRow(Button.primary("rapidfastr", "Rematch"), Button.success("load-again", "↩️ Home"))
                        .queue();
    ...
    public void deleteCurrentMessage() {
        if (buttonEvent.getComponentId().equalsIgnoreCase("delete")) {
            String issuerId = Objects
                    .requireNonNull(buttonEvent.getMessage().getEmbeds().get(0).getFields().get(0).getValue());
            ...
            if (!issuerId.equalsIgnoreCase(buttonEvent.getUser().getAsMention())) {
                ...
                buttonEvent.deferReply(true)
                        .queue(hook -> hook.sendMessage("only op can delete the message!")
                                .queue(message -> hook.deleteOriginal().queueAfter(3, TimeUnit.SECONDS)));
                return;
            }
    ...
    public void sendLearnCommand() {
        ...
        switch (buttonEvent.getComponentId()) {
            case "Bishop" ->
                buttonEvent.editMessageEmbeds(getLearnChessCard("Bishop").build())
                        .setActionRow(Button.primary("Rook", "⬅️"), Button.primary("Knight", "♞")).queue();
            case "Knight" ->
                buttonEvent.editMessageEmbeds(getLearnChessCard("Knight").build())
                        .setActionRow(Button.primary("Bishop", "⬅️"), Button.primary("Queen", "♛")).queue();
            case "Queen" ->
                buttonEvent.editMessageEmbeds(getLearnChessCard("Queen").build())
                        .setActionRow(Button.primary("Knight", "⬅️"), Button.primary("King", "♚")).queue();
            case "Rook" ->
                buttonEvent.editMessageEmbeds(getLearnChessCard("Rook").build())
                        .setActionRow(Button.primary("Bishop", "♝")).queue();
            case "King" ->
                buttonEvent.editMessageEmbeds(getLearnChessCard("King").build())
                        .setActionRow(Button.primary("Queen", "⬅️"), Button.primary("King-castle", "Castle ♚")).queue();
            case "King-castle" ->
                buttonEvent.editMessageEmbeds(getLearnChessCard("King-castle").build())
                        .setActionRow(Button.primary("king", "⬅️"), Button.primary("Pawn", "♟️")).queue();
            case "Pawn" ->
                buttonEvent.editMessageEmbeds(getLearnChessCard("Pawn").build())
                        .setActionRow(Button.primary("King-castle", "⬅️"), Button.primary("Pawn-en", "En-passant ♟️"))
                        .queue();
            case "Pawn-en" ->
                buttonEvent.editMessageEmbeds(getLearnChessCard("Pawn-en").build())
                        .setActionRow(Button.primary("Pawn-en", "⬅️"), Button.primary("Pawn-pro", "Promotion ♟️"))
                        .queue();
            case "Pawn-pro" ->
                buttonEvent.editMessageEmbeds(getLearnChessCard("Pawn-pro").build())
                        .setActionRow(Button.primary("Pawn-pro", "All set for chess!").asDisabled()).queue();
    ...
    private void buildButtonInputForm() {
        ...
        TextInput targettext = TextInput
                .create("self-user" + "tar-user", "Enter Your Friend Lichess Username", TextInputStyle.SHORT)
        ...
        for (int i = 0; i < LEARN_CHESS.length; i++) {
            for (int j = 0; j < LEARN_CHESS[i].length; i++) {
                if (LEARN_CHESS[i][0].equalsIgnoreCase(searchKey)) {
                    return new EmbedBuilder().setDescription(LEARN_CHESS[i][1]).setImage(LEARN_CHESS[i][2])
                            .setColor(Color.BLUE).setThumbnail(Thumbnail.getChessliseLogo());
                }
            }
        }
